...
The README contains 43 sentences. Its longest sentence has 15 words. An automated extraction on 2026-08-28 found no sentence over 22 words.

## Terminology

| Concept | One term used |
| --- | --- |
| A saved observation and its evidence | record |
| An attached photo or sound | evidence file |
| A possible species | candidate |
| The separately stored sample | demo |
| The downloadable editable backup | JSON |
| The lightweight review document | PDF |
